...
# Construire le binaire healthchecker
RUN CGO_ENABLED=0 GOOS=linux go build -a -installsuffix cgo -o /app/healthchecker healthchecker.go
...
# Copier le binaire healthchecker
